...
function Vehicleview(props) {
    ...
    const userapi = async () => {
      ...
      const handleEdit=(e,rowData)=>{
          props.history.push("/vehicletype",rowData)
      }
    ...
    const handleDelete=(e,rowData)=>{
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            httpClient
            .DELETE(`api-delete/vehicletype/${id}`, false, true)
            .then((resp) => { 
  ...
  return (
    ...
    <div className="heading_line">
        <p className="text04">Vehicle List</p>
      ...
      <button className="btn-details"  id="btn-selected">Type view</button>
    ...
    >
      <Col sm={12} className="cols">
        ...
        tableRef={tableRef}
          ...
          title="Company"
          columns={[
            // { title: "Id", field: "ID",customSort: (a, b) => a.name.length - b.name.length },
